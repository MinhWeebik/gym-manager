...
let fileInput1 = document.getElementById("icon_image");
    ...
    reader.onload = () => {
        ...
        originalImage.onload = () => {
            if (originalImage.width < 200 || originalImage.height < 200) {
                ...
                alert('Kích thước ảnh quá nhỏ. Chọn ảnh có kích thước ít nhất 200x200 px.');
                return;
            }
            ...
            //     viewMode: 1, // Đảm bảo kích thước cắt luôn là 200x200 px
                canvasWidth: 200, // Kích thước canvas ngang
                canvasHeight: 200, // Kích thước canvas dọc
            });
