...
let fileInput1 = document.getElementById("channelAvatar");
    ...
    reader.onload = () => {
        ...
        originalImage.onload = () => {
            if (originalImage.width < 500 || originalImage.height < 500) {
                ...
                alert('Kích thước ảnh quá nhỏ. Chọn ảnh có kích thước ít nhất 500x500 px.');
                return;
            }
            ...
            cropper = new Cropper(image, {
                ...
                //     viewMode: 1, // Đảm bảo kích thước cắt luôn là 500x500 px
                canvasWidth: 500, // Kích thước canvas ngang
                canvasHeight: 500, // Kích thước canvas dọc
            });
