...
//     let tmpPath = null;
//     let uploadSized = 0;
//     //listChunks.forEach(function(smallChunk, chunkIndex) {
//     for(var chunkIndex = 0; chunkIndex < listChunks.length; chunkIndex++) {
//         let smallChunk = listChunks[chunkIndex];
...
//         // Step 2: Upload chunk to the /upload-chunk API using XMLHttpReques
//         $.ajax({
//             url: APPNAME + "/cdn/media/upload-chunk",
//             type: 'POST',
//             async: false,
//             data: chunkFormData,
//             success: function(data) {
...
//         });
//
//         let percent = Math.round((uploadSized/totalSize) * 100);
...
// function uploadSmallChunks(uploadId, listChunks, totalSize) {
//     let tmpPath = null;
//     let uploadSized = 0;
//
//     function uploadChunk(chunkIndex) {
//         if (chunkIndex >= listChunks.length) {
//             // All chunks uploaded, exit
//             return;
//         }
//
//         let smallChunk = listChunks[chunkIndex];
