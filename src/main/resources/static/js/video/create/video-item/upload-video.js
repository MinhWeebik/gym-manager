document.addEventListener("DOMContentLoaded", function () {
    const uploadForm = document.getElementById("form-create-video-item");
    ...
    // const enableChat = document.getElementById("isNew");
    // const privacy = document.getElementById("isHot");
