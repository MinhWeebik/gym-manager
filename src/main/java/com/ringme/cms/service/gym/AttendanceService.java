...
public class AttendanceService {
    ...
    public void add(Long scheduledClassId, Long memberId, String bookingTime) throws Exception {
        try {
            ...
            ScheduledClass scheduledClass = scheduledClassRepository.findById(scheduledClassId).orElseThrow();
            if(attendance == null){
                attendance = new Attendance();
                attendance.setScheduledClass(scheduledClass);
                attendance.setMember(member);
                attendance.setStatus(1);
                attendance.setBookingTime(dateTime.toLocalDate());
